...
// FIGMA Andora (Copy) yguOf0BB6X0G6FBhAVPHb9 node 54-408 -> /assistant/send-retry.
// Real resend: downloads the PDF from the backend, then shares to WhatsApp.
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.body}>
        ...
        <Text style={styles.title}>Mengirim ulang dokumen Anda...</Text>
